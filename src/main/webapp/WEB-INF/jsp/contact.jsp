      ...
      <div class="jumbotron">
        <div class="row text-center">
          <div class="text-center col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h2>Notify Owner and Emergency Point of Contact</h2>
            <p>We will send a text with your contact information to the owners so they can reach you.</p>
          </div>
          <div class="text-center col-lg-12"> 
          
<!--  REGISTRATION FORM START -->

<form:form action="/notify" method="POST" modelAttribute="customer">
  ...
  <div class="form-row">
    ...
    <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputPhoneNum">Your Phone Number</label>
